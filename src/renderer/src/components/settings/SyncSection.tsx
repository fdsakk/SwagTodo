          ...
          <div className="space-y-3">
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-[11px] text-app-text-muted">
                Tip: avoid using <span className="text-app-text-secondary">default</span> on
                shared/public projects. For real security, enable Supabase Auth + RLS policies.
              </p>
            </div>
          </div>
